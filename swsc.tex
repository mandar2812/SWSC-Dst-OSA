...
Before performance bench marks for \emph{OSA} $D_{st}$ prediction are run on the 63 geomagnetic storm events from 1998-2006 in \cite{Ji2012}, training and model selection of \emph{GP-AR} and \emph{GP-ARX} models on independent data sets must be performed. For this purpose we choose segments 00:00 1 January 2008 - 10:00 11 January 2008 and 00:00 15 November 2014 - 23:00 1 December 2014 for training and model selection respectively.
...
\begin{table}
      \caption[]{One Step Ahead $D_{st}$ prediction models}
