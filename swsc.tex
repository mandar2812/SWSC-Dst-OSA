...
\begin{linenumbers}
   ...
   %\institute{Johns Hopkins University, Applied Physics Laboratory, \\ 11100 Johns Hopkins Road, Laurel, Maryland 20723}
...
Auto-regressive models can be improved by including exogenous quantities that can help in improving predictions. It is well known that the solar wind and interplanetary magnetic field are important factors that influence the Earth's geomagnetic state (\citet{JGRA:JGRA11775}, \citet{Russell1974}, \citet{JGRA:JGRA17574}).
